...
const Sidebar = () => {
  ...
  return (
    <>
      <div className="lg:w-[25%] w-full lg:h-full h-auto p-2 flex-col gap-2 text-white lg:flex hidden">
      ...
      {/* Mobile Sidebar */}
      <div className="w-full h-full p-2 flex-col gap-2 text-white lg:hidden flex">
        <div className="bg-[#121212] h-auto rounded flex flex-col justify-around">
          <div
            onClick={() => navigate("/")}
        ...
        <div className="bg-[#121212] h-auto rounded mt-2">
          <div className="p-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <img className="w-8" src={assets.stack_icon} alt="Stack Icon" />
              <p className="font-semibold">Your Library</p>
